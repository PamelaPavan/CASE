...
describe('Student e2e test', () => {
  ...
  const studentSample = {
    ...
    enrollmentDate: '2025-01-25T03:38:55.314Z',
  ...
  describe('new Student page', () => {
    ...
    it('should create an instance of Student', () => {
      ...
      cy.get(`[data-cy="enrollmentDate"]`).type('2025-01-24T23:47');
      cy.get(`[data-cy="enrollmentDate"]`).blur();
      cy.get(`[data-cy="enrollmentDate"]`).should('have.value', '2025-01-24T23:47');
