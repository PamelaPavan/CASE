...
import static com.school.domain.TeacherAsserts.*;
...
class TeacherResourceIT {
    ...
    void partialUpdateTeacherWithPatch() throws Exception {
        ...
        partialUpdatedTeacher.lastName(UPDATED_LAST_NAME).street(UPDATED_STREET).state(UPDATED_STATE).zipCode(UPDATED_ZIP_CODE);
