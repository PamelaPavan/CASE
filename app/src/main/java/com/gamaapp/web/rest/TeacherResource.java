...
import com.gamaapp.domain.Teacher;
import com.gamaapp.repository.TeacherRepository;
...
/**
 * REST controller for managing {@link com.gamaapp.domain.Teacher}.
 */
@RestController
...
public class TeacherResource {
     ...
     */
    @GetMapping("")
    public List<Teacher> getAllTeachers(@RequestParam(name = "eagerload", required = false, defaultValue = "true") boolean eagerload) {
