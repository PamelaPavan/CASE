...
describe('Subject e2e test', () => {
  ...
  const subjectSample = { name: 'monumental' };
  ...
  describe('new Subject page', () => {
    ...
    it('should create an instance of Subject', () => {
      cy.get(`[data-cy="name"]`).type('obscure and towards');
      cy.get(`[data-cy="name"]`).should('have.value', 'obscure and towards');

      cy.get(`[data-cy="description"]`).type('marten');
      cy.get(`[data-cy="description"]`).should('have.value', 'marten');
