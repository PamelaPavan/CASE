...
describe('Teacher e2e test', () => {
  ...
  const teacherSample = { firstName: 'Enzo', lastName: 'Reis', specialization: 'jumbo search terraform' };
  ...
  describe('new Teacher page', () => {
    ...
    it('should create an instance of Teacher', () => {
      ...
      cy.get(`[data-cy="specialization"]`).type('equate truthfully amidst');
      cy.get(`[data-cy="specialization"]`).should('have.value', 'equate truthfully amidst');
