...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '7f4a881c-1708-41d3-bec4-0ec5bf75e185' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('b67b4886-904a-4388-b1e0-12217722cd92');
      cy.get(`[data-cy="name"]`).should('have.value', 'b67b4886-904a-4388-b1e0-12217722cd92');
